...
export function Nav(props) {
  ...
  return (
    ...
    <Navbar className='rounded-none w-full' style={props.DarkNav} fluid rounded>
      <Navbar.Brand  >
        <a href="/" className= 'block md:text-3xl underline md:bg-transparent    text-xl font-bold md:p-0 ' aria-current="page">NewsMonkey</a>
      </Navbar.Brand>
